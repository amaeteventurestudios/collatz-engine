...
function StatBlock({ stat }: StatBlockProps) {
  return (
    <div className="flex flex-col items-center gap-2 p-4 text-center lg:items-start lg:text-left">
  ...
  return (
    <div className="rounded-xl border border-slate-700/80 bg-slate-950 shadow-lg shadow-slate-950/50">
      <div className="grid gap-0 lg:grid-cols-[1fr_auto]">
        {/* Left: text content */}
        <div className="p-6 text-center sm:p-7 lg:text-left">
          {/* Badge row */}
          ...
          {/* Summary */}
          <p className="mx-auto mb-6 text-sm leading-relaxed text-slate-400 sm:max-w-lg lg:mx-0">
            {note.summary}
          </p>
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg border border-teal-500/40 bg-teal-500/10 px-4 py-2.5 text-sm font-semibold text-teal-300 transition-colors hover:bg-teal-500/20 hover:text-teal-200"
          >
            Read note
