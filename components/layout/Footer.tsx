      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10 text-center sm:grid-cols-2 sm:text-left lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mx-auto mt-3 max-w-xs text-xs leading-relaxed text-slate-400 sm:mx-0">
        ...
        {/* ── Bottom bar ─────────────────────────────────────────── */}
        <div className="mt-10 flex flex-col items-center gap-3 border-t border-slate-800 pt-8 text-center sm:flex-row sm:justify-between sm:text-left">
