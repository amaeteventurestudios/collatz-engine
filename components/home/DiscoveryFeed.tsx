const feedEvents = [
  ...
  },
  {
    ...
    time: "Pending",
    title: "Awaiting Collatz engine connection",
    body: "The computation engine that catalogs trajectories has not yet been connected. Batch processing and live records will appear once the engine is online in Phase 3.",
    tag: "Engine",
